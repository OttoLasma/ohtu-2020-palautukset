...
public class KauppaTest {
    ...
    @Test
    public void asiointiTuoteVarastostaJaSuoritetaanOston() {
    	// luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
    ...
    @Test
    public void kaksiTuotettaVarastostaJaSuoritetaanOston() {
    	// luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
        ...
        when(varasto.haeTuote(1)).thenReturn(new Tuote(1, "maito", 5));
        when(varasto.haeTuote(2)).thenReturn(new Tuote(2, "kaakao", 5));
    ...
    @Test
    public void kaksiSamaaTuotettaVarastostaJaSuoritetaanOston() {
    	// luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
    ...
    @Test
    public void yksiTuoteVarastostaJotaOnjaYksiJotaEiOleJaSuoritetaanOston() {
    	// luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
    ...
    @Test
    public void varmistaEttaAloitaAsiointiNollaa() {
    	// luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
        ...
        k.aloitaAsiointi();
        k.lisaaKoriin(1);
        k.aloitaAsiointi();     // ostetaan tuotetta numero 1 eli maitoa
        k.lisaaKoriin(1);
        k.tilimaksu("pekka", "12345");
    ...
    public void poistaKorista() {
        ...
        // sitten suoritetaan varmistus, että pankin metodia tilisiirto on kutsuttu
        verify(varasto).palautaVarastoon(new Tuote(2, "kaakao", 5));  
        // toistaiseksi ei välitetty kutsussa käytetyistä parametreista
